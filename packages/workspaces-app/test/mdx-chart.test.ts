...
import { BARS, LINE } from './fixtures/mdx-charts.ts';
 ...
 * bars. The fixtures are the ones posts write (`fixtures/mdx-charts.ts`), and
 * what the props MEAN is `mdx-chart-props.test.ts` beside this.
 */
