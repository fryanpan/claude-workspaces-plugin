...
def _house_names_block() -> str:
    ...
    return (
        ...
        "surname.\n\n"
        "A full name is crossed off whole when EVERY part of it is on these "
        "lists or on the placeholder list above: `Alice Saltmarsh` is a "
        "placeholder given name and a house surname, `Bob Harborlight` the "
        "same. Neither is a person, and a first-and-last shape does not make "
        "one out of two placeholders.\n\n"
